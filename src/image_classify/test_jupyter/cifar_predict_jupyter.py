...
def load_batch(fpath):
    object = file_io.read_file_to_string(fpath, True)
...
def main(_):
    ...
    img_obj = file_io.read_file_to_string(predict_pic, True)
...
if __name__ == '__main__':
    ...
    #获得buckets路径
    parser.add_argument('--buckets', type=str, default='/input/tensorflow/cifar-10-batches-py',
                        help='input data path')
    #获得checkpoint路径
    parser.add_argument('--checkpointDir', type=str, default='/input/tensorflow/check_point',
